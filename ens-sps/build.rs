...
fn main() -> Result<(), anyhow::Error> {
    let file_names = [
        "abi/oldethregistrar_contract.abi.json",
        "abi/baseregistrar_contract.abi.json",
        "abi/ethregistrar_contract.abi.json",
        "abi/namewrapper_contract.abi.json",
        "abi/dnsregistrar_contract.abi.json",
    ];
    let file_output_names = [
        "src/abi/oldethregistrar_contract.rs",
        "src/abi/baseregistrar_contract.rs",
        "src/abi/ethregistrar_contract.rs",
        "src/abi/namewrapper_contract.rs",
        "src/abi/dnsregistrar_contract.rs",
    ];
