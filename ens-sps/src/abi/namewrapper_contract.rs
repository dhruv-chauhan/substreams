...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct CanExtendSubnames {
        pub node: [u8; 32usize],
        pub addr: Vec<u8>,
    }
    impl CanExtendSubnames {
        const METHOD_ID: [u8; 4] = [14u8, 76u8, 215u8, 37u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for CanExtendSubnames {
        const NAME: &'static str = "canExtendSubnames";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for CanExtendSubnames {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct IsWrapped1 {
        pub parent_node: [u8; 32usize],
        pub labelhash: [u8; 32usize],
    }
    impl IsWrapped1 {
        const METHOD_ID: [u8; 4] = [217u8, 165u8, 12u8, 18u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for IsWrapped1 {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for IsWrapped1 {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct IsWrapped2 {
        pub node: [u8; 32usize],
    }
    impl IsWrapped2 {
    ...
    impl substreams_ethereum::Function for IsWrapped2 {
        const NAME: &'static str = "isWrapped";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for IsWrapped2 {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl SetMetadataService {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_metadata_service),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl SetUpgradeContract {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.u_upgrade_address),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl UTokens {
        const METHOD_ID: [u8; 4] = [219u8, 239u8, 103u8, 121u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for UTokens {
        const NAME: &'static str = "u_tokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for UTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl Upgrade {
        const METHOD_ID: [u8; 4] = [201u8, 58u8, 179u8, 253u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
